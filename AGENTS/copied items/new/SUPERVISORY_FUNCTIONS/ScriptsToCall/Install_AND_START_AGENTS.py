...
AGENT_COMMANDS = [
    {
        ...
        "config": os.path.expanduser("~/AGENTS/Modbus_Comm_Agent/config"),
        "tag": "MY_Modbus_Agent",
    },
    {
        "path": os.path.expanduser("~/AGENTS/DataBase_Agent/"),
        "config": os.path.expanduser("~/AGENTS/DataBase_Agent/config"),
        "tag": "MY_DataBase_Agent",
    },
    {
        "path": os.path.expanduser("~/AGENTS/ESC_Volt_Reg_Agent/"),
        "config": os.path.expanduser("~/AGENTS/ESC_Volt_Reg_Agent/config"),
        "tag": "MY_ESC_VoltReg",
    },
    {
    ...
    },
    {
        ...
        "config": os.path.expanduser("~/AGENTS/FixPower_Agent/config"),
        "tag": "MY_FixPQ_Agent",
    },
    {
        "path": os.path.expanduser("~/AGENTS/Operational_Agent/"),
        "config": os.path.expanduser("~/AGENTS/Operational_Agent/config"),
        "tag": "MY_Ops_Agent",
    },
    {
        "path": os.path.expanduser("~/AGENTS/PowerUPDown_Agent/"),
        "config": os.path.expanduser("~/AGENTS/PowerUPDown_Agent/config"),
        "tag": "MY_PwrCntrl_ESC_Agent",
    },
    {
        "path": os.path.expanduser("~/AGENTS/PQ_CurFit_Agent/"),
        "config": os.path.expanduser("~/AGENTS/PQ_CurFit_Agent/config"),
        "tag": "MY_Curve_Fit_Agent",
    },
    {
        "path": os.path.expanduser("~/AGENTS/VoltageRegulation_Agent/"),
        "config": os.path.expanduser("~/AGENTS/VoltageRegulation_Agent/config"),
